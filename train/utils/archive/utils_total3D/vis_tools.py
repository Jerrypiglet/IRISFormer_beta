...
# OR_mapping_folder = Path('utils_OR/openrooms/')
# OR4X_mapping_id_to_color_file = OR_mapping_folder / 'openrooms_colors.txt'
# with open(str(OR4X_mapping_id_to_color_file)) as f:
#     color_list = f.read().splitlines()
# OR4X_mapping_id_to_color_dict = {idx: [float(x) / 255. for x in color_list[idx].split(' ')] for idx in range(len(color_list))} # [0., 1.]

# print('++++++nyu_color_palette', nyu_color_palette[1])
# print('++++++OR4X_mapping_id_to_color_dict', OR4X_mapping_id_to_color_dict[1])
