...
_C.PATH.torch_home_cluster = ['/viscompfs/users/ruizhu/', '/home/ruzhu/Documents/torch', '/newfoundland/torch']
...
_C.PATH.pretrained_cluster = ['/viscompfs/users/ruizhu/pretrained', '/home/ruzhu/Documents/Projects/semanticInverse/pretrained', '/newfoundland/semanticInverse/pretrained/']
...
_C.DATASET.dataset_path_cluster = ['/siggraphasia20dataset/code/Routine/DatasetCreation/', '', '/newfoundland/data/siggraphasia20dataset/code/Routine/DatasetCreation/']
...
# _C.DATASET.png_path_cluster = ['/siggraphasia20dataset/pngs', '/local/ruzhu/data/OR-pngs', '/newfoundland/data/OR-pngs']
_C.DATASET.png_path_cluster = ['/siggraphasia20dataset/pngs', '/local/ruzhu/data/OR-pngs', '/datasets_mount/OR-pngs'] # mainDiffLight_xml  mainDiffLight_xml1  mainDiffMat_xml  mainDiffMat_xml1  main_xml  main_xml1
...
# _C.DATASET.dataset_path_mini_cluster = ['', '/local/ruzhu/data/openrooms_mini', '/newfoundland/data/openrooms_mini']
_C.DATASET.dataset_path_mini_cluster = ['', '/local/ruzhu/data/openrooms_mini', '/datasets_mount/openrooms_mini']
