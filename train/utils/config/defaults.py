...
_C.DATASET.dataset_path_binary_local = '/newfoundland/ruizhu/ORfull-seq-240x320'
# _C.DATASET.dataset_path_binary_cluster = ['/ruidata/ORfull-seq-240x320', '/local/ruzhu/data/ORfull-seq-240x320', '/datasets_mount/ORfull-seq-240x320']
