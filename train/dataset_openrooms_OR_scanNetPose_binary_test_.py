...
class openrooms_binary(data.IterableDataset):
    ...
    def __iter__(self): # https://gist.github.com/kklemon/c745e9ee2474f6907f2a3189c0da68b5  
        ...
        for meta_split, scene_name in meta_split_scene_name_list_per_worker:
            ...
            for frame_id in sample_id_list:
                ...
                # print(idx, len(meta_split_scene_name_list_per_worker), len(sample_id_list), len(self.scene_key_frame_id_list))
                yield batch_dict
                # print('======', len(self.meta_split_scene_name_list), worker_info.id, self.opt.rank, '======', len(meta_split_scene_name_list_per_worker))
                # if (idx + shift) % mod == 0:
                #     yield batch_dict
    ...
    def __(self):
        ...
        if self.opt.cfg.DATA.if_also_load_next_frame:
            ...
            im_SDR_RGB_next = im_fixedscale_SDR_uint8_next.astype(np.float32) / 255.
        ...
        # im_fixedscale_SDR_uint8: im_SDR_RGB -> 255

        # print('------', image_transformed_fixed.shape, im_trainval.shape, im_trainval_SDR.shape, im_SDR_RGB.shape, im_fixedscale_SDR_uint8.shape, )
        ...
        batch_dict.update({'hdr_scale': hdr_scale, 'image_transformed_fixed': image_transformed_fixed, 'im_trainval': im_trainval, 'im_trainval_SDR': im_trainval_SDR, 'im_SDR_RGB': im_SDR_RGB, 'im_fixedscale_SDR_uint8': im_fixedscale_SDR_uint8})
    ...
    def convert_write_png(self, hdr_image_path, seg, png_image_path):
        ...
        im_SDR_RGB = np.clip(im_fixedscale**(1.0/2.2), 0., 1.)
