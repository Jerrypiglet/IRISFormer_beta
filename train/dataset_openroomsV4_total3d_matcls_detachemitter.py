...
class openrooms(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt.cfg.DATA.if_load_png_not_hdr:
            ...
            im_trainval = im_fixedscale_SDR # [240, 320, 3], np.ndarray
        ...
        batch_dict.update({'hdr_scale': hdr_scale, 'image_transformed_fixed': image_transformed_fixed, 'im_trainval': torch.from_numpy(im_trainval), 'im_trainval_SDR': im_trainval_SDR, 'im_fixedscale_SDR': im_fixedscale_SDR, 'im_fixedscale_SDR_uint8': im_fixedscale_SDR_uint8})
