...
def parse_args():
    ...
    create_parser.add_argument('--deploy_tar', type=str, help='deploy to target path', default='/ruidata/dptInverse/job_list')
    create_parser.add_argument('--deploy_train_path', type=str, help='deploy to target path', default='/ruidata/dptInverse/train')
    create_parser.add_argument('--python_path', type=str, help='python path in pod', default='/ruidata/envs/py38dptinverse/bin/python')
    create_parser.add_argument('--pip_path', type=str, help='python path in pod', default='/ruidata/envs/py38dptinverse/bin/pip')
