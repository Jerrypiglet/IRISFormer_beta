...
DEST_PATH = Path('/ruidata/openrooms_raw_BRDF_test')
# DEST_PATH = Path('/newdata/ruizhu/openrooms_raw_light')
# DEST_PATH = Path('/home/ruizhu/Documents/Projects/semanticInverse/tmp_val_OR')
LIST_path = Path('/home/ruizhu/Documents/Projects/semanticInverse/train/data/openrooms/list_OR_V4full_zhengqinCVPR/list')
# PERCENT = 0.25
PERCENT = 1
...
if if_cluster:
    ...
    dataset_path_dict['train'] = '/home/ruizhu/Documents/Projects/semanticInverse/dataset/openrooms_test'
