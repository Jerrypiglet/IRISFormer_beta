...
#include "deform_im2col.h"
#include "modulated_deform_conv.h"

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("deform_conv_forward", &deform_conv_forward, "deform_conv_forward");
  m.def("deform_conv_backward", &deform_conv_backward, "deform_conv_backward");
  m.def("deform_im2col_forward", &deform_im2col_forward, "deform_im2col_forward");
  m.def("deform_im2col_backward", &deform_im2col_backward, "deform_im2col_backward");
