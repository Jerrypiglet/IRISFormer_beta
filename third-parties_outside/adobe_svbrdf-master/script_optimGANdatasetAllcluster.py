...
out_dir = '/eccv20dataset/BRDFScaledDatasetLatent'
progressFile = '/siggraphasia20dataset/code/Routine/DatasetCreation/material/genScaledLatentProgress_%d_%d.txt' % (start, end)
existMatList = []
