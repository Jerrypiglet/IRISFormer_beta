...
out_dir = '/eccv20dataset/BRDFScaledDatasetLatentWfixN'
#progressFile = '/siggraphasia20dataset/code/Routine/DatasetCreation/material/genScaledLatentWfixNProgress_%d_%d.txt' % (start, end)
progressFile = '/eccv20dataset/adobe_svbrdf-master/tmp/genScaledLatentWfixNProgress_%d_%d.txt' % (start, end)
existMatList = []
