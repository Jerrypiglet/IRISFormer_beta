...
def init_global_noise(imres, init_from):
     ...
     if init_from == 'random':
          ...
          noise_4_2 = th.zeros(1, 1, 4, 4, dtype=th.float32)
          noise_8_1 = th.zeros(1, 1, 8, 8, dtype=th.float32)
          noise_8_2 = th.zeros(1, 1, 8, 8, dtype=th.float32)
          noise_16_1 = th.zeros(1, 1, 16, 16, dtype=th.float32)
          noise_16_2 = th.zeros(1, 1, 16, 16, dtype=th.float32)
          noise_32_1 = th.zeros(1, 1, 32, 32, dtype=th.float32)
          noise_32_2 = th.zeros(1, 1, 32, 32, dtype=th.float32)
          noise_64_1 = th.zeros(1, 1, 64, 64, dtype=th.float32)
          noise_64_2 = th.zeros(1, 1, 64, 64, dtype=th.float32)
          noise_128_1 = th.zeros(1, 1, 128, 128, dtype=th.float32)
          noise_128_2 = th.zeros(1, 1, 128, 128, dtype=th.float32)
          noise_256_1 = th.zeros(1, 1, 256, 256, dtype=th.float32)
          noise_256_2 = th.zeros(1, 1, 256, 256, dtype=th.float32)
     else:
