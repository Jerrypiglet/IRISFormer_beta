...
test_dict=torch.load("/eccv20dataset/elvis/NYU/test/file.pth")
...
dictt=torch.load("/eccv20dataset/elvis/NYU/train/file.pth")
...
cfg.OUTPUT_DIR=outfiledir+'out_open_nyu_2class'
