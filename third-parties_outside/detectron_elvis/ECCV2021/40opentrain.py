...
for d in ["test"]:
    ...
    MetadataCatalog.get("light_" + d).set(thing_classes=name_list)
...
dictt=torch.load("/eccv20dataset/elvis/labelTransform/TRAIN/file.pth")
